...
if !exists("did_php_syn_inits")
  ...
  "hi phpComment ctermfg=gray cterm=none

  "hi phpFunctions ctermfg=green cterm=bold
  "hi phpClasses ctermfg=green cterm=bold
  "hi phpMethods ctermfg=green cterm=bold
  "hi phpIdentifier ctermfg=green cterm=bold
  "hi phpIdentifierSimply ctermfg=green cterm=bold
  "hi phpIdentifierSimply ctermfg=green cterm=bold
  "hi Constant ctermfg=green cterm=bold

  "hi phpParent ctermfg=green cterm=none

  "hi phpVarSelector ctermfg=yellow cterm=bold
  "hi phpStringSingle ctermfg=yellow cterm=bold
  "hi phpStringDouble ctermfg=yellow cterm=bold
