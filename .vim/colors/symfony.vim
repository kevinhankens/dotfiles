...
highlight Normal ctermfg=15 ctermbg=232 guifg=#ffffff guibg=#111111
...
highlight lCursor ctermfg=15 ctermbg=232 guifg=bg guibg=fg
...
highlight Ignore ctermbg=232 guifg=bg
...
highlight LineNr ctermfg=232 ctermbg=147 guifg=#2B2B2B guibg=#C0C0FF
highlight NonText ctermfg=239 ctermbg=232 guifg=#505050 guibg=#222222
