...
hi Function     guifg=#e16521 gui=bold cterm=bold
hi Statement    guifg=#dbb800   gui=bold cterm=bold
hi Operator     guifg=#988155   gui=none
hi Type         guifg=#f6f080   gui=none
hi StorageClass guifg=#7D6C55 cterm=bold
hi String       guifg=#4d6537 
hi Character    guifg=#707576
hi Special      guifg=#ebac47 cterm=bold
hi Delimiter    guifg=#935e29
hi SpecialComment guifg=#73817d
hi Underlined   guifg=#73817d gui=underline
"hi Tag          guifg=#ebac47
hi Keyword      guifg=#ff3a55   gui=bold cterm=bold
